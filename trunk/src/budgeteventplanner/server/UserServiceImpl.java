...
public class UserServiceImpl extends RemoteServiceServlet implements UserService {
  ...
  @Override
  public void register(String email, String password, Integer role) throws NoSuchAlgorithmException {
    // String encrypted =
  ...
  @Override
  public Integer login(String email, String password) throws NoSuchAlgorithmException {
    // String encrypted =
    // MessageDigest.getInstance("SHA-1").digest(password.getBytes()).toString();
    String encrypted = password;
    Objectify ofy = ObjectifyService.begin();
