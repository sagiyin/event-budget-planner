...
public class EventBudgetPanel extends Composite {
  ...
  private final DecoratorPanel panelBudget = new DecoratorPanel();
  ...
  public EventBudgetPanel(String usrID) {
    ...
    //Budget Panel
    budget_h_panel.add(panelBudget);
  ...
  public void refreshBudgetTree() {
    ...
    treeBudget.addSelectionHandler(new SelectionHandler<TreeItem>() {
      public void onSelection(SelectionEvent<TreeItem> event) {
        panelBudget.clear();
        panelBudget.add(new BudgetPanel(event.getSelectedItem().getTitle()));
      }
    });
  }
            ...
            for (Event e : result) {
              ...
              event_del.addClickHandler(new ClickHandler() {
                public void onClick(ClickEvent event) {
                  ...
                  eventService.changeEventStatusByEventId(eventId, Event.INACTIVE,
            ...
            for (Event e : result) {
              ...
              event_del.addClickHandler(new ClickHandler() {
                public void onClick(ClickEvent event) {
                  ...
                  eventService.changeEventStatusByEventId(eventId, Event.TRASHED,
                      new AsyncCallback<Void>() {
                        public void onFailure(Throwable caught) {
              ...
              restore.addClickHandler(new ClickHandler() {
                ...
                public void onClick(ClickEvent event) {
                  ...
                  final int temp = r;
                  eventService.changeEventStatusByEventId(eventId, Event.ACTIVE,
                      new AsyncCallback<Void>() {
                        public void onFailure(Throwable caught) {
    ...
    save_d.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        ...
        if (flag == 0) {
          ...
          eventService.createEvent(organizerId, event_title.getText(), start_date.getValue(),
              end_date.getValue(), location.getText(), new AsyncCallback<Void>() {
                public void onFailure(Throwable caught) {
          ...
          eventService.updateEventByEventId(event_id, event_title.getText(), start_date.getValue(),
              end_date.getValue(), location.getText(), Event.ACTIVE, new AsyncCallback<Void>() {
                public void onFailure(Throwable caught) {
                }
  ...
  public void view_info_pop_up(String eventId, String eventTitle, String startDate, String endDate,
      String location) {
    final DialogBox d = new DialogBox();
        ...
        for (ServiceRequest sr : result) {
          ...
          if (s.getStatus() == ServiceRequest.ACCEPTED) {
            ...
            delete.addClickHandler(new ClickHandler() {
              ...
              @Override
              public void onClick(ClickEvent event) {
                vendorService.updateServiceRequestStatus(s.getRequestId(), ServiceRequest.IGNORED,
                    new AsyncCallback<Void>() {
                      public void onFailure(Throwable caught) {
                      }
    ...
    if (pendingDelete == true) {
      vendorService.updateServiceRequestStatus(serviceList.get(pendingDeleteTarget).getRequestId(),
    ...
    addBudget.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        if (budget_limit.getText().isEmpty() || budget_name.getText().isEmpty()) {
          ...
          budgetService.createBudget(tempEventList.get(eventListBox.getSelectedIndex())
              .getEventId(), budget_name.getText(), Double.parseDouble(budget_limit.getText()),
    ...
    addBudget.addClickHandler(new ClickHandler() {
      public void onClick(ClickEvent event) {
        if (budget_limit.getText().isEmpty()) {
          ...
          budgetService.addBudgetItemToBudget(
              tempCategoryList.get(categoryListBox.getSelectedIndex()).getCategoryId(),
