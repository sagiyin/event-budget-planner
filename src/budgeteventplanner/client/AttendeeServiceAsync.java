...
public interface AttendeeServiceAsync {
	...
	void getAttendeeListByOrganizerId(String organizerId, AsyncCallback<ArrayList<Attendee>> callback);
	void getAttendeeListByEventId(String eventId, AsyncCallback<ArrayList<Attendee>> callback);
	void updateAttendeeInfo(String attendeeId, String name, String email, String jobTitle, String companyName, String address, String phoneNum, Integer status, AsyncCallback<Void> callback);
